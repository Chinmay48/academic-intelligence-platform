...
import { Eye, EyeOff, Sparkles, BookOpen, Clock, BarChart3 } from "lucide-react";
...
function Register() {
  ...
  const handleSubmit=(e)=>{
       ...
       try {
        setLoading(true);
        const payLoad={
          ...formData,year:formData.role==="STUDENT"?Number(formData.year):null
        }
    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-slate-50 font-sans selection:bg-blue-500 selection:text-white">
          ...
          <div className="flex justify-center items-center p-6 relative">
            ...
            >
              ...
              <div className="mb-10">
                <h2 className="text-3xl font-extrabold text-slate-900 tracking-tight">Welcome Folk</h2>
                <p className="text-slate-500 mt-2 font-medium">Register to continue</p>
              </div>
              
              <form className="space-y-5" onSubmit={handleSubmit}>

                <div className="space-y-1.5">
                  <label className="block text-sm font-semibold text-slate-700 ml-1">Name Address</label>
