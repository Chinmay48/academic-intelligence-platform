...
function StudentAnalytics() {
  ...
  const topTopic = analytics?.topTopics?.length > 0 ? analytics.topTopics[0].topic : "-";
  const predictedTopic = analytics?.predictedQuestions?.length > 0 ? analytics.predictedQuestions[0].topic : "-";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 pt-4">
        ...
        >
          ...
          <p className="text-slate-500 text-base max-w-2xl ml-12">
            Analyze previous examination patterns, discover important topics, and prepare intelligently with predictive analytics.
          </p>
        </motion.div>
        ...
        >
          <div className="max-w-xl">
            ...
            <div className="relative">
              ...
              >
                <option value="">
                  {loadingSubjects ? "Loading subjects..." : "Choose a subject to analyze..."}
                </option>
              ...
              <div className="absolute inset-y-0 right-5 flex items-center pointer-events-none">
                <Activity className={`w-5 h-5 ${selectedSubject ? 'text-indigo-500' : 'text-slate-400'}`} />
              </div>
            </div>
          </div>
        </motion.div>
          ...
          {!selectedSubject && (
            ...
            >
              ...
              <p className="text-base text-slate-500 max-w-md">
                Select a subject above to generate AI-driven PYQ patterns, topic frequencies, and examination predictions.
              </p>
            </motion.div>
          )}
          ...
          {selectedSubject && analytics && (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                ...
                <motion.div variants={itemVariants} initial="rest" whileHover="hover" animate="rest" className="bg-white rounded-3xl border border-slate-100 p-6 relative overflow-hidden group">
                    ...
                    {topTopics.slice(0, 8).map((topic, index) => (
                      ...
                      >
                        <div className="flex items-center gap-4 overflow-hidden">
                          ...
                          <span className="font-semibold text-slate-700 truncate" title={topic.topic}>
                            {topic.topic}
                          </span>
                        </div>
                      ...
                      >
                        <div className="flex items-center gap-4 overflow-hidden">
                          ...
                          <div className="truncate">
                            <p className="font-semibold text-slate-700 truncate" title={topic.topic}>
                              {topic.topic}
                            </p>
